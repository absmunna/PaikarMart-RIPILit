      ...
      <div className="container mx-auto px-4 py-8 flex flex-col gap-6">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-white/60 mt-1">How customers see your storefront on PaikarMart.</p>
          </div>
          {!editing ? (
        ...
        <GlassCard className="overflow-hidden">
          <div
            className="h-40 bg-gradient-to-r from-emerald-900 via-[hsl(160_28%_5%)] to-purple-900 bg-cover bg-center"
          ...
          <div className="p-6 flex flex-col md:flex-row gap-6 -mt-12">
            <img
              ...
              className="w-24 h-24 rounded-full border-4 border-[hsl(160_28%_5%)] object-cover"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <GlassCard className="p-6 flex flex-col gap-4">
            ...
            <Row label="Seller Type" icon={<ShieldCheck className="w-4 h-4" />}>
              {editing ? (
                <Select value={form.type} onValueChange={(v: SellerType) => setForm({ ...form, type: v })}>
          ...
          <GlassCard className="p-6 flex flex-col gap-4">
            ...
            <p className="text-xs text-white/50 -mt-2">Used by PaikarMart support — not shown publicly.</p>
